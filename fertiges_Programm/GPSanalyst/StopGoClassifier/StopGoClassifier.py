...
class StopGoClassifier():
  ...
  def __init__(self, overwrite_settings=None):
    ...
    self.settings = {
        'MIN_STOP_INTERVAL': 360,#63, # time in seconds, stops below this threshold will be ignored
        'RELEVANT_STOP_DURATION': 480,#178, # time in seconds, stops longer than this will always be kept
